        ...
        if age is not None:
            ...
            if age <= 0 or age >=65:
                validation_result = build_validation_result(
                    False,
                    "age",
                    "To use our services we need you must be of the appropriate age,"
                    " Please provide an age under 64 if you would like to continue."
                )
        if investment_amount is not None:
            ...
            if investment_amount < 5000:
                validation_result = build_validation_result(
                    False,
                    "investment_amount",
                    "Our services require an intial investment of 5000 dollars or more."
                    " Please provide a valid intial investment."
                )
